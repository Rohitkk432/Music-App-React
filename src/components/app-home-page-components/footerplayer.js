    ...
    return(
        <>
            <div className="footer-player">
                ...
                <div className="foot-music-controls-icons">
                    <FontAwesomeIcon className="icons12" icon={faRandom} aria-hidden="true" />
                    <FontAwesomeIcon className="icons12" icon={faUndo} aria-hidden="true" />
                    <FontAwesomeIcon className="icons12" icon={faStepBackward} aria-hidden="true" />
                    <FontAwesomeIcon className="icons12" icon={faPlay} aria-hidden="true" />
