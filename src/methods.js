...
const checkExistingUser = async function(email){
    const response = await fetch(`https://localhost:5000/users/${email}`)
        .then((res)=>res.json())
        .then((user)=>{
            return user;
        })
...
const registerNewUser = async function(email){
    const newReg = await fetch('https://localhost:5000/users',{
            method:"POST",
...
const getAllSongs = async function(){
    const response = await fetch(`https://localhost:5000/songs`)
        .then((res)=>res.json())
        .then((songsList)=>{
            return songsList;
        })
...
const getFullQueue = async function(user_id){
    const response = await fetch(`https://localhost:5000/queue/${user_id}`)
        .then((res)=>res.json())
        .then((queueList)=>{
            return queueList;
        })
...
const checkSongInQueue = async function(user_id,song_id){
    const response = await fetch('https://localhost:5000/queue',{
            method:"GET",
            headers:{"Content-Type": "application/json"},
...
const getFullLiked = async function(user_id){
    const response = await fetch(`https://localhost:5000/liked/${user_id}`)
        .then((res)=>res.json())
        .then((likedList)=>{
            return likedList;
        })
...
const checkSongInLiked = async function(user_id,song_id){
    const response = await fetch('https://localhost:5000/liked',{
            method:"GET",
            headers:{"Content-Type": "application/json"},
            body: JSON.stringify({"user_id":`${user_id}`,"song_id":`${song_id}`})
        })
...
const getFullPlaylist = async function(user_id,playlist_number){
    const response = await fetch('https://localhost:5000/playlist/full',{
            method:"GET",
            headers:{"Content-Type": "application/json"},
...
const checkSongInPlaylist = async function(user_id,song_id,playlist_number){
    const response = await fetch('https://localhost:5000/playlist',{
            method:"GET",
            headers:{"Content-Type": "application/json"},
